...
config_pri_assets {
    OTHER_FILES += \
        $$quote($$BASEDIR/assets/720x720/BingoTile.qml) \
        $$quote($$BASEDIR/assets/BingoTile.qml) \
        $$quote($$BASEDIR/assets/Example.qml) \
        $$quote($$BASEDIR/assets/functions.js) \
        $$quote($$BASEDIR/assets/images/greenbox.png) \
        $$quote($$BASEDIR/assets/images/whitebox.png) \
